import { l as head, a as attr_class, s as stringify, j as attr, f as ensure_array_like, e as escape_html, h as derived, F as FILENAME } from "../../../chunks/index4.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      ...
      push_element($$renderer2, "p", 240, 3);
      ...
      $$renderer2.push(` `);
      {
        ...
        push_element($$renderer2, "div", 247, 3);
        ...
        push_element($$renderer2, "div", 252, 7);
        Search($$renderer2, {
          size: 20,
        ...
        push_element($$renderer2, "input", 257, 8);
        pop_element();
        $$renderer2.push(`</div>`);
        pop_element();
        ...
        push_element($$renderer2, "button", 266, 7);
        Search($$renderer2, { size: 18 });
        $$renderer2.push(`<!----> <span>`);
        push_element($$renderer2, "span", 272, 8);
        ...
        if (studentsWithStats.length > 0) {
          ...
          push_element($$renderer2, "button", 275, 8);
          X($$renderer2, { size: 18 });
          $$renderer2.push(`<!----></button>`);
          pop_element();
        } else {
        ...
        if (studentsWithStats.length > 0) {
          ...
          push_element($$renderer2, "table", 314, 7);
          $$renderer2.push(`<thead>`);
          push_element($$renderer2, "thead", 315, 8);
          $$renderer2.push(`<tr${attr_class(tableHeaderBg(), "svelte-1dbxbgy")}>`);
          push_element($$renderer2, "tr", 316, 9);
          ...
          push_element($$renderer2, "tbody", 325, 8);
          $$renderer2.push(`<!--[-->`);
          ...
          for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
            ...
            push_element($$renderer2, "tr", 327, 10);
            ...
            push_element($$renderer2, "button", 334, 12);
            History($$renderer2, { size: 16 });
            $$renderer2.push(`<!----> <span>`);
            push_element($$renderer2, "span", 339, 13);
          ...
          push_element($$renderer2, "div", 395, 6);
          User($$renderer2, { size: 48, class: `mx-auto mb-3 ${stringify(textMuted())}` });
          $$renderer2.push(`<!----> <p${attr_class(`text-sm ${stringify(textMuted())}`, "svelte-1dbxbgy")}>`);
          push_element($$renderer2, "p", 397, 7);
          ...
          push_element($$renderer2, "p", 400, 7);
