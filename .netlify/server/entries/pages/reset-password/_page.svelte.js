...
function _page($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      ...
      push_element($$renderer2, "div", 53, 4);
      ...
      $$renderer2.push(`<!--]--> `);
      {
        ...
        push_element($$renderer2, "div", 124, 7);
