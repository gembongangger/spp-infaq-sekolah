	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/penarikan/_server.ts.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/penarikan/_id_/setuju/_server.ts.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/penarikan/_id_/tolak/_server.ts.js'))
			},
			{
				id: "/api/siswa",
				pattern: /^\/api\/siswa\/?$/,
